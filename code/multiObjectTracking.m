...
function multiObjectTracking(indexMat)
...
% foreground objects, and displaying results.
    ...
    function obj = setupSystemObjects()
        ...
        obj.writer = vision.VideoFileWriter('mot_output.avi', 'FrameRate',obj.reader.info.VideoFrameRate);
...
% displays the frame and the mask in their respective video players.
    ...
    function displayTrackingResults()
        ...
        boxCounts = [boxCounts size(bboxes,1)];
        F = getframe;
